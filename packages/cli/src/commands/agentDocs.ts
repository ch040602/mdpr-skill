...
const topics: AgentDocTopicSpec[] = [
  ...
  },
  {
    ...
    dense: [
      ...
      "Treat the supplied PPTX/POTX slide master as the primary visual system.",
    ...
    full: [
      ...
      "When supported by the target MDPR runtime, set preservation/media/icon policies to keep master slides, source images, and no-new-icons behavior explicit.",
  ...
  },
  {
    ...
    dense: [
      ...
      "For Korean or mixed Korean/English decks, prefer shorter claim titles, label/detail bullets, and notes over exact line-break instructions.",
  ...
  },
  {
    ...
    dense: [
      ...
      "Flag duplicate-theme application when `--template` is combined with MDPR theme flags without an explicit style-transform request.",
      "Flag awkward Korean/English wrapping as a source cleanup issue, not a coordinate/font prescription.",
